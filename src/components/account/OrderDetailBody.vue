            ...
            <ul class="g-itemList g-itemList-dashed">
              <li class="g-itemList_item g-media g-media-lg g-media-narrow">
                ...
                <div class="g-media_body g-units-sm">
                  ...
                  <p class="g-font-sm">商品コード {{ detail.goodsCode }}</p>
                  <ul class="g-font-sm" style="font-size: 0.8rem">
                    <li>カラー:{{ detail.color }}</li>
                    <li>組立サービス：なし</li>
                    <li>引取サービス：なし</li>
...
const detailList = computed(() => store.getters.getOrderDetail);
console.log("orderDetail", detailList);
</script>
